                           ...
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            <?php
                                ...
                                $A['Sunny'] = [
                                    ...
                                    'contacts1' => '<a href="https://twitter.com/@myplaneticket" class="text-info fs-sm" target="_blank">@myplaneticket</a> - ',
                                    'contacts2' => '<a href="https://wrapbootstrap.com/user/myorange" class="text-info fs-sm" target="_blank" title="Contact Sunny"><i class="fal fa-envelope"></i></a>',
                                ];
                                $A['Jos'] = [
                                    ...
                                    'contacts1' => '<a href="https://twitter.com/@atlantez" class="text-info fs-sm" target="_blank">@atlantez</a> - ',
                                    'contacts2' => '<a href="https://wrapbootstrap.com/user/Walapa" class="text-info fs-sm" target="_blank" title="Contact Jos"><i class="fal fa-envelope"></i></a>',
                                ];
                                $A['Jovanni'] = [
                                    ...
                                    'position2' => 'Partner &amp; Contributor',
                                    'contacts1' => '<a href="https://twitter.com/@lodev09" class="text-info fs-sm" target="_blank">@lodev09</a> - ',
                                    'contacts2' => '<a href="https://wrapbootstrap.com/user/lodev09" class="text-info fs-sm" target="_blank" title="Contact Jovanni"><i class="fal fa-envelope"></i></a>',
                                ];
                                $A['Roberto'] = [
                                    ...
                                    'position2' => 'Partner &amp; Contributor',
                                    'contacts1' => '<a href="https://twitter.com/@sildur" class="text-info fs-sm" target="_blank">@sildur</a> - ',
                                    'contacts2' => '<a href="https://wrapbootstrap.com/user/sildur" class="text-info fs-sm" target="_blank" title="Contact Roberto"><i class="fal fa-envelope"></i></a>',
                                ];
                                foreach ($mens as $man) {
                                    if ($man == 'Sunny') {
                                        echo $flex;
